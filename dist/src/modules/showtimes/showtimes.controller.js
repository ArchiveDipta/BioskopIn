...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Membuat jadwal tayang baru (Khusus Admin)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Melihat ketersediaan kursi secara real-time (Publik)' }),
