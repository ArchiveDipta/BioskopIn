...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [verify_google_dto_1.VerifyGoogleDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "verifyAndroidToken", null);
__decorate([
    (0, common_1.Get)('google'),
    (0, swagger_1.ApiOperation)({ summary: 'Login menggunakan Google (Web)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Callback dari Google (Jangan dipanggil manual)' }),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('google')),
    __param(0, (0, common_1.Req)()),
