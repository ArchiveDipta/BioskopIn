...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Membuat studio baru & kursi otomatis (Khusus Admin)' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, swagger_1.ApiOperation)({ summary: 'Melihat semua studio (Khusus Admin)' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, swagger_1.ApiOperation)({ summary: 'Melihat detail studio dan kursinya (Khusus Admin)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, swagger_1.ApiOperation)({ summary: 'Menghapus studio beserta kursinya (Khusus Admin)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
